            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="post" id="demo-form2" action="ajouterEmploye" data-parsley-validate class="form-horizontal form-label-left">

                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align " for="name" >Num Employe : <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input type="text" id="name" name="idEmploye" required="required"  class="form-control">
                           </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align " for="name" >Nom Employe : <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input type="text" id="name" name="nomEmploye" required="required"  class="form-control">
                          <span class="fa fa-user form-control-feedback right" aria-hidden="true"></span>
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align ">Email Employe : <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6" >
                            <input type='text' class="form-control" name="emailEmploye" required="required" />
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align ">Date de Naissance Employe : <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6" >
                        <div class='input-group date' id='myDatepicker2'>
                            <input type='text' class="form-control" name="dateNaissanceEmploye" required="required" />
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Salaire Employe : (DHS)<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <select  name="salaireEmploye" class="form-control" required="required">
                            <option selected disabled >Salaire</option>
                            <option>10000</option>
                            <option>20000</option>
                            <option>30000</option>
                          </select>
                       ...
                       <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Mot de passe Employe : <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="mdpEmploye" required="required" class="form-control" />
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">CNI Employe : <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="cniEmploye" required="required" class="form-control" />
                        </div>
                      </div>
                      
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align " for="name" >NumT : <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6">
                          <input type="text" id="name" name="numT" required="required"  class="form-control">
                           </div>
                      </div>
