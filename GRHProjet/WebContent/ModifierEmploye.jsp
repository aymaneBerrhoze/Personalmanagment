            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form method="post" id="demo-form2" action="updateEmploye" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                          <input type="text" id="name" name="nomEmploye" value="${ idEmploye.nomEmploye}" required="required"  class="form-control">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align ">Email Employe : <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6" >
                            <input type='text' class="form-control" name="emailEmploye" value="${ idEmploye.emailEmploye}" required="required" />
                      ...
                      <div class="item form-group">
                        ...
                        <div class='input-group date' id='myDatepicker2'>
                            <input type='text' class="form-control" name="dateNaissanceEmploye" value="${ idEmploye.dateNaissanceEmploye}" required="required" />
                            <span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true" style="color:blue"></i>
                      ...
                      <div class="item form-group">
                        <label class="col-form-label col-md-3 col-sm-3 label-align" >Salaire Employe : <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 ">
                          <select name="salaireEmploye"  class="form-control" required="required">
                            <option value="${ idEmploye.salaireEmploye}" selected disabled>${ idEmploye.salaireEmploye}</option>
                            <option >10000</option>
                            <option >20000</option>
                            <option >30000</option>
                          </select>
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="mdpEmploye" value="${ idEmploye.mdpEmploye}" required="required" class="form-control" />
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 ">
                          <input type="text" id="last-name" name="cniEmploye" value="${ idEmploye.cniEmploye}" required="required" class="form-control" />
                        </div>
                      </div>
