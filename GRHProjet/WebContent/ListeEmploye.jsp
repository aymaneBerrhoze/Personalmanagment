                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">Nom Employe </th>
                        ...
                        <tbody>
                          <tr class="even pointer">
                            <td class="a-center ">
                              <input type="checkbox" value="${em.idEmploye}" class="flat" name="table_records">
                            </td>
                           <td class=" ">${em.nomEmploye }</td>
                            <td class=" last"><a href="afficherEmploye?idEmploye=${em.idEmploye}" class="btn btn-primary btn-xs"
														><i class="fa fa-folder"></i></a>
                            </td>
                            <td class=" last"><a href="edit?idEmploye=${em.idEmploye}" class="btn btn-info btn-xs"
														><i class="fa fa-pencil"></i></a>
                            </td>
                            <td class=" last"><a href="supprimerEmploye?idEmploye=${em.idEmploye}" class="btn btn-danger btn-xs"
														><i class="fa fa-trash" onclick="return confirm('Etes-vous sure de vouloir supprimer cet employe?');"></i></a>
                             </td>
