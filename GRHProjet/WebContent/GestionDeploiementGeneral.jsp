...
<link
	href="vendors/vendors/datatables.net-bs/css/dataTables.bootstrap.min.css"
	rel="stylesheet">
<link
	href="vendors/vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css"
	rel="stylesheet">
<link
	href="vendors/vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css"
	rel="stylesheet">
<link
	href="vendors/vendors/datatables.net-responsive-bs/css/responsive.bootstrap.min.css"
	rel="stylesheet">
<link
	href="vendors/vendors/datatables.net-scroller-bs/css/scroller.bootstrap.min.css"
	rel="stylesheet">
...
<!-- Bootstrap -->
<link href="vendors/vendors/bootstrap/dist/css/bootstrap.min.css"
	rel="stylesheet">
<!-- Font Awesome -->
<link href="vendors/vendors/font-awesome/css/font-awesome.min.css"
	rel="stylesheet">
<!-- NProgress -->
<link href="vendors/vendors/nprogress/nprogress.css" rel="stylesheet">
<!-- iCheck -->
<link href="vendors/vendors/iCheck/skins/flat/green.css"
	rel="stylesheet">

<!-- bootstrap-progressbar -->
<link
	href="vendors/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css"
	rel="stylesheet">
<!-- JQVMap -->
<link href="vendors/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet" />
<!-- bootstrap-daterangepicker -->
<link
	href="vendors/vendors/bootstrap-daterangepicker/daterangepicker.css"
	rel="stylesheet">

<!-- Custom Theme Style -->
<link href="build/build1/css/custom.min.css" rel="stylesheet">
<link rel="icon" type="image/png" href="images/images4/icons/GRH.png" />
</head>
...
<body class="nav-md">
		...
		<div class="main_container">
			<div class="col-md-3 left_col">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="HomeAdmin.jsp" class="site_title"><i
							class="fa fa-cogs"></i> <span>G.R.H</span></a>
					</div>
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="images/images1/img.jpg" alt="..."
					...
					<div id="sidebar-menu"
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-refresh"></i> Gestion de
										deploiement <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
						...
						<div class="menu_section">
							<h3>Live On</h3>
							<ul class="nav side-menu">
								<li><a><i class="fa fa-envelope"></i> Additional Pages
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings"
							href="editAdmin?loginAdmin=${admin}"> <span
							class="glyphicon glyphicon-cog" aria-hidden="true"></span>
						</a> <a data-toggle="tooltip" data-placement="top" title="FullScreen">
							<span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
						</a> <a data-toggle="tooltip" data-placement="top" title="Profil"
							href="ProfilAdmin?loginAdmin=${admin}"> <span
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="images/images1/img.jpg"
									alt="">${admin }
							</a>
								<div class="dropdown-menu dropdown-usermenu pull-right"
									aria-labelledby="navbarDropdown">
									<a class="dropdown-item" href="ProfilAdmin?loginAdmin=${admin}">
							...
							<li role="presentation" class="nav-item dropdown open"><a
								href="listeMessage" class="dropdown-toggle info-number"> <i
			...
			<div class="right_col" role="main">
				<div class="container">
					<div align="center">
						<c:if test="${i>=2}">
							<a href="rotationLeftA?i=${i}" class="previous round">&#8249;</a>
						</c:if>
						<a href="rotationRightA?i=${i}" class="next round">&#8250;</a>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td width="136" colspan="2" align="center"
										...
										size="2" color="#000000"><b>${l[2]}</b></font></td>
									<td width="153" colspan="2" align="center"
										style="background-color: #CA7826;"><font face="Calibri"
								...
								<tr>
									...
									<td width="136" colspan="2" align="center"
										style="background-color: #FFCA8A;"><font face="Calibri"
										size="2" color="#000000"><b>${l[6]}</b></font></td>
									<td width="153" colspan="2" align="center"
										style="background-color: #E5FB05;"><font face="Calibri"
										size="2" color="#000000"><b>${l[3]}</b></font></td>
									<td width="143" colspan="2" align="center"
										style="background-color: #FA0A06;"><font face="Calibri"
								...
								<tr>
									...
									<td width="68" align="center"
										style="background-color: #F76308;"><font face="Calibri"
										size="2" color="#000000"><b>${l[8]}</b></font></td>
								...
								<tr>
									...
									<td width="78" align="center"
										...
										size="2" color="#000000"><b>${l[4]}</b></font></td>
									<td width="78" align="center"
										style="background-color: #9908F7;"><font face="Calibri"
	...
	<script
		src="JSs/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
	...
	<!-- bootstrap-progressbar -->
	<script
		src="vendors/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
	<!-- iCheck -->
	...
	<!-- Flot plugins -->
	<script
		src="vendors/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
	...
	<script
		src="vendors/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
	<!-- bootstrap-daterangepicker -->
	<script src="vendors/vendors/moment/min/moment.min.js"></script>
	<script
		src="vendors/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
